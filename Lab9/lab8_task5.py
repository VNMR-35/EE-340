...
class lab8_task5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab8_task5")
        ...
        self.samp_rate_2 = samp_rate_2 = 100000
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.qtgui_sink_x_2, 0))
...
def main(top_block_cls=lab8_task5, options=None):
