...
class lab9_task2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 9 Task 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 9 Task 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab9_task2")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\vinam\\Documents\\Semester_5\\EE 340\\Lab9\\Original_Text.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\vinam\\Documents\\Semester_5\\EE 340\\Lab9\\New_Text.txt', False)
...
def main(top_block_cls=lab9_task2, options=None):
