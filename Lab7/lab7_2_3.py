...
class lab7_2_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab7_2_3")
        ...
        self.widget.addTab(self.widget_widget_0, 'Before Multipath, with noise')
        ...
        self.widget.addTab(self.widget_widget_1, 'After Multipath, with noise')
        ...
        self.widget.addTab(self.widget_widget_2, 'After Equalizer')
        ...
        self.widget.addTab(self.widget_widget_3, 'Error')
        ...
        self.widget.addTab(self.widget_widget_4, 'With Calculated Coefficients')
        ...
        self.widget_layout_3.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.widget_layout_4.addWidget(self._qtgui_const_sink_x_0_0_0_0_win)
        ...
        self.widget_layout_2.addWidget(self._qtgui_const_sink_x_0_0_0_win)
        ...
        self.widget_layout_1.addWidget(self._qtgui_const_sink_x_0_0_win)
        ...
        self.widget_layout_0.addWidget(self._qtgui_const_sink_x_0_win)
        ...
        self.iir_filter_xxx_1_1 = filter.iir_filter_ccf([1,-0.5,0.25,-0.125,0.0625], [1], True)
        ...
        self.connect((self.blocks_throttle_0_0_0_0, 0), (self.qtgui_const_sink_x_0_0_0_0, 0))
        ...
        self.connect((self.iir_filter_xxx_0, 0), (self.iir_filter_xxx_1_1, 0))
        ...
        self.connect((self.iir_filter_xxx_1_1, 0), (self.blocks_throttle_0_0_0_0, 0))
...
def main(top_block_cls=lab7_2_3, options=None):
