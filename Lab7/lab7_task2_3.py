...
class lab7_task2_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 7 Tasks 2 & 3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 7 Tasks 2 & 3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab7_task2_3")
        ...
        self.tab_layout_2.addWidget(self._qtgui_const_sink_x_0_0_0_0_win)
        ...
        self.blocks_throttle_0_0_0_1 = blocks.throttle(gr.sizeof_gr_complex*1, 128000,True)
        self.blocks_throttle_0_0_0 = blocks.throttle(gr.sizeof_gr_complex*1, 128000,True)
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(500000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(500000, analog.GR_SIN_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(500000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.iir_filter_xxx_0, 0))
        ...
        self.connect((self.blocks_throttle_0_0_0_1, 0), (self.qtgui_const_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_throttle_0_0_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_throttle_0_0_0_1, 0))
        self.connect((self.digital_costas_loop_cc_0, 0), (self.iir_filter_xxx_1, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_costas_loop_cc_0, 0))
        self.connect((self.iir_filter_xxx_0, 0), (self.blocks_add_xx_0, 0))
...
def main(top_block_cls=lab7_task2_3, options=None):
