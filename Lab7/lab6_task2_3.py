...
class lab6_task2_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 6 Tasks 2 & 3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 6 Tasks 2 & 3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab6_task2_3")
...
def main(top_block_cls=lab6_task2_3, options=None):
