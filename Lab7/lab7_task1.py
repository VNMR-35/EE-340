...
class lab7_task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iir_filter_xxx_0 = filter.iir_filter_ffd([1, 0.5], [1], True)
        ...
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_float*1, 500000,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 500000,True)
