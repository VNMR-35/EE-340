...
class lab7_task4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 7 Task 4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 7 Task 4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab7_task4")
...
def main(top_block_cls=lab7_task4, options=None):
