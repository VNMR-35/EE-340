...
class lab6_task3a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 6 Task 3a")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 6 Task 3a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab6_task3a")
...
def main(top_block_cls=lab6_task3a, options=None):
