...
class lab6_task3b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 6 Task 3b")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 6 Task 3b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab6_task3b")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\Users\\vinam\\Documents\\Semester_5\\EE 340\\Lab6\\input2.bin', True, 0, 0)
...
def main(top_block_cls=lab6_task3b, options=None):
